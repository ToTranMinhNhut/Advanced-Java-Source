...
public class Order {
	...
	public Order(String dateOrder, int invoice, String state, Customer customer, Card card,
			DetailOrder[] listDetailOrder, int detailOrderNumber) {
		super();
	...
	public int getDETAILORDERMAX() {
		return DETAILORDERMAX;
	}
	...
	public void inputOrder() throws NumberFormatException, IOException {
		...
		try {
			...
			while (next < DETAILORDERMAX) {
				...
				int opt = 1;
				System.out.println("Do you buy next product? Please choose: <1 (Yes)/ 0 (No)>:");
	...
	public boolean order() throws NumberFormatException, IOException{
		...
		System.out.println("Do you Order? Please choose: <1 (Order)/ 0(Don't Order)>:");
